                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="parent_id">
                        ...
                        @foreach ($departments as $child_department)
                            @if ($department->id !== $child_department->id)
                                <option class="form-control" {{ $department->parent_id == $child_department->id ? 'selected ' : ' ' }} value="{{ $child_department->id }}">{{$child_department->name}}</option>
                            @endif 
                        @endforeach
                    </select>
                </div>
